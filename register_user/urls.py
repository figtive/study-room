...
urlpatterns = [
    ...
    path('forget/auth/', views.forget_password_auth, name="forget_auth"),
    path('reset/auth/', views.reset_password_auth, name="reset_auth"),
    ...
    re_path(r'^reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$',views.reset_password, name="reset"),
    re_path(r'^reset/auth/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$',views.reset_password_auth, name="reset_auth"),
]
